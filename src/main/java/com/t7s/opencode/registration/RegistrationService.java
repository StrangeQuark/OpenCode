package com.t7s.opencode.registration;

import com.t7s.opencode.email.EmailSender;
import com.t7s.opencode.registration.token.ConfirmationToken;
import com.t7s.opencode.registration.token.ConfirmationTokenService;
import com.t7s.opencode.user.UserRepository;
import com.t7s.opencode.user.UserRole;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        //Check that the regex of the email is valid, if not throw an exception
